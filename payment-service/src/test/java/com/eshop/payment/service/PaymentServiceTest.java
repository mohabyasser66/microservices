...
//     @BeforeEach
//     void setUp() {
//         paymentRequest = new PaymentGatewayRequest();
...
//         // When
//         PaymentGatewayResponse response = paymentService.processPayment(paymentRequest);
...
//         // When
//         Optional<PaymentGatewayResponse> response = paymentService.getPaymentStatus(1L);
...
//         // Given
//         RefundGatewayRequest refundRequest = new RefundRequest();
...
//         // When
//         RefundGatewayResponse response = paymentService.processRefund(refundRequest);
